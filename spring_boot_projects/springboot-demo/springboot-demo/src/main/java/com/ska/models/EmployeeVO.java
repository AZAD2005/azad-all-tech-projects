...
public class EmployeeVO implements Comparable<EmployeeVO>, Serializable {
    ...
    public static List<EmployeeVO> fetchAllEmployeesCustomized() {
        ...
        customizedEmpList.add(new EmployeeVO(4, "john", new Date(), 12345d, false));
